...
//!
//! Всё здесь читается без драйверов: WMI и счётчики производительности. Температура
//! процессора на Ryzen без драйвера недоступна, и её тут сознательно нет —
//! лучше не показать величину, чем показать выдуманную.
